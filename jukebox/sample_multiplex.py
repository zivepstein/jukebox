...
def save_samples(model, device, hps, sample_hps):
    ...
    lyrics = ["Almost anybody can learn to think or believe or know, but not a single human being can be taught to feel. Why? Because whenever you think or you believe or you know, you’re a lot of other people: but the moment you feel, you’re nobody-but-yourself."]
    temps = [0.98]
            ...
            for lyric in lyrics:
                for temp in temps:
                    ...
                    sampling_kwargs = [dict(temp=0.99, fp16=True, chunk_size=lower_level_chunk_size, max_batch_size=lower_level_max_batch_size),
                                       ...
                                       dict(temp=temp, fp16=True, chunk_size=chunk_size, max_batch_size=max_batch_size)]
